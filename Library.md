...
The standard library is called "standard.cat". This file contains definitions of commonly used functions expressed in terms of the [built-in primitive functions](Primitives.md). This is similar in concept to the Haskell standard prelude.
