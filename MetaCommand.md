...
The meta-commands are:
  ...
  * `#m` - Apply loaded macros to a quotation on stack. Usage: `[swap swap] #m`. See also: [Macros](Macros.md).
  ...
  * `#o` - Optimizes a quotation using a combination of techniques. Usage: `[[1 +] map [3 *] map] #o`. See also: [Optimization](Optimization.md).
  * `#c` - Compiles a quotation into a CIL dynamic assembly and creates an output file "out.exe". Usage: `[42 writeln] #c`. See also: [Compilation](Compilation.md).
  * `#run` - Runs a dynamic assembly. Usage: `[42 writeln] #c #run`. See also: [Compilation](Compilation.md).
